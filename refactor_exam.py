#!/usr/bin/env python3
"""
Refactor istqb_exam_enhanced.py to v3.0 with Select TWO and Calculation Questions
"""
...
with open('istqb_exam_enhanced.py', 'w', encoding='utf-8') as f:
    f.write(refactored_content)

print('✓ Refactoring Complete!')
print()
print('Key Improvements:')
print('  1. Added "select_count" field (1 or 2) to all questions')
print('  2. Added "type" field (normal or calculation)')
print('  3. ~2 "Select TWO" questions per exam (~5%)')
print('  4. ~2 "Calculation" questions per exam (~5%)')
print('     - Confusion matrix calculations (Precision, Recall, F1)')
print('     - Distribution bias & representativeness metrics')
print('  5. Updated UI to display "Select One/Two Answer:"')
print('  6. Checkbox support for Select TWO questions')
print('  7. Updated shuffle_question_options() for multiple answers')
print('  8. Updated calculate_score() to handle both single & multiple')
print('  9. Scoring: K2=1pt, K3=2pts (both must be correct for Select TWO)')
print('  10. Results show [Select 2] indicator for Multi-select questions')
print()
print('Statistics:')
print('  - Total questions in bank: ~120+')
print('  - Questions per exam: 40')
print('  - K2 Questions: 36 (34 Select ONE + 2 Select TWO)')
print('  - K3 Questions: 4')
print('  - Total exams: 10')
print()
print('✓ File saved as: istqb_exam_enhanced.py')
print('✓ Original backup: istqb_exam_enhanced.py.backup')
